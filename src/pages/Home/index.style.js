...
export const PopoverIconContainer = styled.div`
  ...
  box-shadow: 0px 2px 8px rgba(51, 51, 51, 0.12),
    0px 1px 2px rgba(51, 51, 51, 0.12);
  background: #ffffff;
  margin-right: 8px;
`
...
export const ShotcutIcon = styled.div`
  background-color: ${props =>
    props.active ? '#F8524B' : 'rgba(255, 148, 145, 0.16)'};
  border-radius: 50%;
  height: 64px;
  width: 64px;
  display: flex;
...
export const PopoverNotification = styled.div`
  box-shadow: 0px 0px 2px rgba(51, 51, 51, 0.05),
    0px 14px 16px rgba(51, 51, 51, 0.05), 0px 4px 8px rgba(51, 51, 51, 0.05),
    0px 2px 4px rgba(51, 51, 51, 0.05), 0px 0px 8px rgba(51, 51, 51, 0.05);
  border-radius: 24px;
  background: #ffffff;
  padding: 16px;
  display: flex;
